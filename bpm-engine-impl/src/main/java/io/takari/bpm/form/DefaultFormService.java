...
public class DefaultFormService implements FormService {
    ...
    public void create(String processBusinessKey, UUID formInstanceId, String eventName,
        ...
        Form f = new Form(processBusinessKey, formInstanceId, eventName, formDefinition, env, Collections.<String, Object>emptyMap());
    ...
    public static Form prepare(ExpressionManager em, FormValidator validator, Form form) throws ExecutionException {
        ...
        env = new HashMap<>(env != null ? env : Collections.<String, Object>emptyMap());
        ...
        allowedValues = new HashMap<>(allowedValues != null ? allowedValues : Collections.<String, Object>emptyMap());
