...
public class ScriptTaskTest extends AbstractEngineTest {
    ...
    public void testJs() throws Exception {
        final double a = System.currentTimeMillis();
        final double b = 1234;
    ...
    public void testJsInOut() throws Exception {
        final double outerA = System.currentTimeMillis();
        final double innerB = 2345;
        ...
        JavaDelegate t2 = spy(new JavaDelegate() {
            ...
            @Override
            public void execute(ExecutionContext ctx) throws Exception {
                Object c = ctx.getVariable("outerC");
                assertNotNull(c);
            }
        });
        getServiceTaskRegistry().register("t2", t2);
