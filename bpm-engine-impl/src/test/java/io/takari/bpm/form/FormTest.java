...
public class FormTest extends AbstractEngineTest {
    ...
    public void testSimple() throws Exception {
        ...
        final String formField = "testValue";
        final String testValue = "test#" + System.currentTimeMillis();
        ...
        FormSubmitResult r = formService.submit(formInstanceId, Collections.<String, Object>singletonMap(formField, "abc"));
        ...
        r = formService.submit(formInstanceId, Collections.<String, Object>singletonMap("testValue", testValue));
    ...
    public void testDefaultValue() throws Exception {
        ...
        FormSubmitResult r = formService.submit(formInstanceId, Collections.<String, Object>singletonMap(formField, "b"));
        assertTrue(r.isValid());
    }
}
